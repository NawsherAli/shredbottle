                    ...
                    <div class="d-flex align-items-center">
                        <div class="text-center text-sm-left ">
                            <div class="avatar avatar-image" style="width: 150px; height:150px">
                                <img src="{{asset('assets/images/avatars/'.$transaction->fundraiser->user->profile_image)}}" alt="">
                            </div>
                        </div>
                        <div class="text-center text-sm-left m-v-15 p-l-30">
                            <h2 class="m-b-5 title-responsive">{{$transaction->fundraiser->user->name}}!</h2>
                            <p class="text-dark m-b-20">{{$transaction->fundraiser->company_name}}</p>
                            <!-- <span class="btn btn-primary">{{$transaction->fundraiser->company_name}}</span> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                        ...
                        <div class="col">
                            <ul class="list-unstyled m-t-10">
                                <li class="row">
                                    ...
                                    <p class="col font-weight-semibold text-black">{{$transaction->fundraiser->user->contact}}</p>
                                </li>
                                <li class="row">
                                    <p class=" col-3 font-weight-semibold text-dark m-b-5">
                                    ...
                                    <p class="col font-weight-semibold text-black"> {{$transaction->fundraiser->user->email}}</p>
                                </li>
                                <li class="row">
                                    <p class="col-3 font-weight-semibold text-dark m-b-5">
                                    ...
                                    <p class="col font-weight-semibold text-black"> {{$transaction->fundraiser->address}}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card bg-primary-light br-tl-br-50">
                <div class="card-body flex-column align-items-center justify-content-center">
                    <div class="">
                        ...
                        <p class="m-b-0 text-primary" style="font-size: 10px">Total Donations </p>
            ...
            <div class="card bg-primary-light br-tl-br-50">
                <div class="card-body flex-column align-items-center justify-content-center">
                    <div class="">
                        ...
                        <h2 class="m-b-0 text-primary">
                            <span>${{$transaction->fundraiser->current_balance}} </span>
                        </h2>
                        <p class="text-primary" style="font-size: 10px">+ {{$this_week_donation}} $ this week</p>
                    </div>    
                </div>
        ...
        <div class="table-responsive  ">
                <table class="table table-sm ">
                    <tbody>
                        ...
                        <tr>
                            <th>Customer Name</th>
                            <td><input type="text" name="name" value="{{$transaction->fundraiser->user->name}}" class="form-control" readonly></td>
                        </tr>
                        <tr>
                            <th>Request Date</th>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="amount" value="{{old('amount')}}" class="form-control" ></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="transaction_id" value="{{old('transaction_id')}} " class="form-control"></td>
                        </tr>
                        <tr>
                            <th> </th>
