                ...
                <div class="col-md-7">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text-center text-sm-left m-v-15 p-l-30">
                            <h2 class="m-b-5 title-responsive">Hello,{{$service->name}} </h2>
                            <p class="text-dark m-b-20">{{$service->name}}</p>
    ...
    <form method="POST" action="{{route('services.update',['id' => $service->id])}}"  enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="name" placeholder="Enter Charity Name" name="name" value="{{$service->name}}">
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea name="short_desc" class="form-control"  id="short_desc">{{$service->short_desc}}</textarea>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12">
                <label for="long_desc" class="text-primary">Long Descriptions</label>
                <textarea name="long_desc" class="form-control" id="long_desc">{{$service->long_desc}}</textarea>
