...
<div class="row mb-3" style="border-bottom: 2px solid #219653">
    <div class="col-md-6 order-sm-1 order-1 col-8">
        <h1 class="title-responsive">Create Blog</h1>
    </div>
    ...
    <form method="POST" action="{{route('blogs.store')}}"  enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name" class="text-primary">Blog Title</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Blog Title" name="name">
            </div>
            <div class="form-group col-md-6">
