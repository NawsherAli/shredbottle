...
<div class="row mb-3" style="border-bottom: 2px solid #219653">
    <div class="col-md-6 order-sm-1 order-1 col-8">
        <h1 class="title-responsive">Add Charity Type</h1>
    </div>
    
</div>
<!-- <div class="row"> -->
    <form method="POST" action="{{route('charities.store')}}"  enctype="multipart/form-data">
        @csrf
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name" class="text-primary">Charity Name</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Charity Name" name="name">
            </div>
            <div class="form-group col-md-6">
