...
class ClaimBalanceRequestNotification extends Notification
{
    use Queueable;
    ...
    {   
        ...
        ->view('emails.claim_balance_request', [
            'name' => $this->customData['name'],
            'user_name' => $this->customData['user_name'],
            'request_id' => $this->customData['request_id'],
            'contact' => $this->customData['contact'],
