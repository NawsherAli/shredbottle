...
<div class="row mb-3 bg-primary pt-2 br-5 " style="border-bottom: 2px solid #219653">
    ...
    <div class="col-md-4 order-sm-2 order-3 ">
       <form id="searchForm" method="GET" action='{{ route("$role.fundraising.donation.search") }}'>
            <div class="input-affix m-b-10">
                <input type="text" class="form-control" placeholder="Search By Charity Name" name="search">
    ...
    <div class="col-md-2 order-sm-3 order-2 col-4 ">
        <div class="dropdown dropdown-animated scale-left">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href='{{ route("$role.fundraising.donations.sort.latest") }}'>Sort By Latest Funds</a>
                <a class="dropdown-item" href='{{ route("$role.fundraising.donations.sort.highest") }}'>Sort By Highest Funds</a>
            </div>
        </div>
    </div>
</div>
