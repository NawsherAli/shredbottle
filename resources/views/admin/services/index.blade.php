...
<div class="row mb-3">
    <div class="col-md-6 order-sm-1 order-1 col-7 mt-2" >
        <h1 class="title-responsive">All Services</h1>
    </div>
    <div class="col-12 col-md-4 order-sm-2 order-3  mt-3  " >
        ...
        <form id="searchForm" method="GET" action="{{ route('services.search') }}">
            <div class="input-affix  ">
            <input type="text" class="form-control" placeholder="Search" name="search">
        ...
        <table class="table table-sm text-center">
            <thead>
                <tr class="bg-primary">
                    ...
                    <th scope="col" class="text-white">Service Name</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src='{{asset("assets/images/services/$service->image")}}'  alt="" height="200px" width="200px"></td>
                    <td>{{$service->name}}</td>
                    <td>{!!$service->short_desc!!}</td>
                    <td>
                        
                        <a href="{{ route('services.edit', ['id' => $service->id]) }}" class="badge badge-pill badge-blue"><i class="fas fa-edit    br-100"></i></a>
                        <a href="#" data-toggle="modal" data-target="#serviceDelete{{$service->id}}" class="badge badge-pill badge-red"><i class="fas fa-trash-alt   br-100"></i> </a>

                        <!-- Modal -->
                        <div class="modal fade" id="serviceDelete{{$service->id}}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                <form id="service-delete-form-{{ $service->id }}" action="{{ route('services.destroy', ['id' => $service->id]) }}" method="post" style="">
                                @csrf
                                @method('POST')
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure to Delete this service record!</p>
                                    </div>
...
<div class="">
    ...
    <div class="col-12  br-10 border-primary1 pb-2 d-block d-sm-none mb-3">
         ...
         <div>
             <p class="text-black"><b>Descriptions:</b>{!!$service->short_desc!!}</p>
         </div>
         <div class="d-flex justify-content-end align-items-center" >
                <a href="{{ route('services.edit', ['id' => $service->id]) }}" class="badge badge-pill badge-blue"><i class="fas fa-edit    br-100"></i></a>
                <a href="#" data-toggle="modal" data-target="#MobileserviceDelete{{$service->id}}" class="badge badge-pill badge-red"><i class="fas fa-trash-alt   br-100"></i> </a>

                        <!-- Modal -->
                        <div class="modal fade" id="MobileserviceDelete{{$service->id}}" >
