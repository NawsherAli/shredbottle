...
<div class="row mb-3">
                        ...
                        <div class="col-md-4 order-sm-2 order-3 d-flex justify-content-end align-items-center mt-2" >
                            <div class="input-affix  ">
                                <input type="text" class="form-control" placeholder="Search">
                                <i class="suffix-icon anticon anticon-search"></i>
                            </div>
                        </div>
                        <div class="col-md-4 order-sm-3 order-2 col-6 d-flex justify-content-end align-items-center mt-2" >
...
<table class="table table-sm text-center">
        ...
        <tbody>
            <tr>
                ...
                <td>@mdo</td>
                <td>@mdo</td>
                <td><span class="badge badge-pill badge-pending mr-3">Pending</span><a href="driver-details.html"><i class="fas fa-external-link-alt table-view-icon p-5 badge-success-lighter br-100"></i></a></td>
            </tr>
            <tr>
                <th scope="row">2</th>
                <td>Jacob</td>
