...
<div class="row mb-3">
    <div class="col-md-6 order-sm-1 order-1 col-7 mt-2" >
        <h1 class="title-responsive">All Blogs</h1>
    </div>
    <div class="col-12 col-md-4 order-sm-2 order-3  mt-3  " >
        ...
        <form id="searchForm" method="GET" action="{{ route('blogs.search') }}">
            <div class="input-affix  ">
            <input type="text" class="form-control" placeholder="Search" name="search">
        ...
        <table class="table table-sm text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src='{{asset("assets/images/blogs/$blog->image")}}'  alt="" height="200px" width="200px"></td>
                    <td>{{$blog->name}}</td>
                    <td>{!!$blog->short_desc!!}</td>
                    <td>
                        
                        <a href="{{ route('blogs.edit', ['id' => $blog->id]) }}" class="badge badge-pill badge-blue"><i class="fas fa-edit    br-100"></i></a>
                        <a href="#" data-toggle="modal" data-target="#blogDelete{{$blog->id}}" class="badge badge-pill badge-red"><i class="fas fa-trash-alt   br-100"></i> </a>

                        <!-- Modal -->
                        <div class="modal fade" id="blogDelete{{$blog->id}}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                <form id="blog-delete-form-{{ $blog->id }}" action="{{ route('blogs.destroy', ['id' => $blog->id]) }}" method="post" style="">
                                @csrf
                                @method('POST')
...
<div class="">
    ...
    <div class="col-12  br-10 border-primary1 pb-2 d-block d-sm-none mb-3">
         ...
         <div class="d-flex justify-content-between" >
             <h3 class="text-primary">{{$blog->name}}</h3>
         </div>
         <div>
             <p class="text-black"><b>Descriptions:</b>{!!$blog->short_desc!!}</p>
         </div>
         <div class="d-flex justify-content-end align-items-center" >
                <a href="{{ route('blogs.edit', ['id' => $blog->id]) }}" class="badge badge-pill badge-blue"><i class="fas fa-edit    br-100"></i></a>
                <a href="#" data-toggle="modal" data-target="#MobileblogDelete{{$blog->id}}" class="badge badge-pill badge-red"><i class="fas fa-trash-alt   br-100"></i> </a>

                        <!-- Modal -->
                        <div class="modal fade" id="MobileblogDelete{{$blog->id}}" >
