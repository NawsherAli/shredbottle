...
<div class="row mb-3" style="border-bottom: 2px solid #219653">
    ...
    <div class="col-md-4 order-sm-2 order-3 ">
        <form id="searchForm" method="GET" action="{{ route('fundraiser.transaction.search') }}">
    ...
    <div class="col-md-2 order-sm-3 order-2 col-4 ">
        <div class="dropdown dropdown-animated scale-left">
            ...
            <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('fundraiser.transaction.filter', ['sort' => 'latest']) }}">Latest Transactions</a>
                  <a class="dropdown-item" href="{{ route('fundraiser.transaction.filter', ['sort' => 'completed']) }}">Completed Transactions</a>
                  <a class="dropdown-item" href="{{ route('fundraiser.transaction.filter', ['sort' => 'pending']) }}">Pending Transactions</a> 
            </div>
        </div>
    </div>
</div>
