...
<!-- <div class="form-group col-md-6  ">
	...
	<div class="form-group col-md-12  ">
	    ...
	    <textarea class="form-control" aria-label="With textarea" name="address">Enter Address</textarea>
	</div>
</div>
<div class="form-row">
<div class="form-group col-md-6  ">
...
<div class="form-group col-md-3 col-6  d-flex align-items-end justify-content-end">
    <button class="btn  border-primary1 showbtn" style="width: 200px; display: none">Cancel</button>
</div>
<div class="form-group col-md-3 col-6  d-flex align-items-end justify-content-end">
